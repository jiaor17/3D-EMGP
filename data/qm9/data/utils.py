...
from data.qm9.data.dataset import ProcessedDataset
from data.qm9.data.prepare import prepare_dataset
...
def initialize_datasets(datadir, dataset, subset=None, splits=None,
    ...
    num_val = datasets['valid'].num_pts
    num_test = datasets['test'].num_pts

    return num_train, num_val, num_test, datasets, num_species, max_charge
